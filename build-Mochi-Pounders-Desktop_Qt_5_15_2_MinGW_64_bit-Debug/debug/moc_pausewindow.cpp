...
#include <memory>
#include "../../Mochi-Pounders/pausewindow.h"
...
QT_MOC_LITERAL(4, 24, 24), // "on_button_resume_clicked"
QT_MOC_LITERAL(5, 49, 27) // "on_button_main_menu_clicked"

    },
    "pausewindow\0go\0\0cleanup\0"
    "on_button_resume_clicked\0"
    "on_button_main_menu_clicked"
};
...
void pausewindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_button_resume_clicked(); break;
        case 3: _t->on_button_main_menu_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pausewindow::go)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (pausewindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pausewindow::cleanup)) {
                *result = 1;
                return;
            }
        }
